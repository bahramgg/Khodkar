...
- [x] **هفته ۶** — draft-approval مالک + leads + سؤال‌های بی‌جواب.
  - DoD: فلوی ✅/✏️/❌ end-to-end (+ ثبت لید + تبدیل سؤال بی‌جواب به FAQ).
- [x] **هفته ۷** — Interview Agent + sandbox + اتصال کامل آنبوردینگ.
...
- [x] **هفته ۱۲** — پایلوت: ۳ tenant فعال + NPS + باگ‌لیست.
  - DoD: ۳ tenant فعال (E2E: هر سه پاسخ زنده از کاتالوگ)، NPS محاسبه شد، باگ‌لیست کار می‌کند.

🎉 **نقشه‌ی راه ۱۲ هفته‌ای کامل شد.**
