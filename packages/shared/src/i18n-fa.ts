...
export const fa = {
  ...
  panel: {
    ...
    home: {
      ...
      turnOn: 'روشن کردن ربات',
      turnOff: 'موقتاً خاموش کن',
      sendSampleReport: 'ارسال گزارش هفتگی نمونه',
      reportSent: 'گزارش به تلگرام مالک ارسال شد ✅',
      reportSaved: 'گزارش ساخته و ذخیره شد (تلگرام مالک هنوز متصل نیست).',
    },
  ...
  agent: {
    ...
    paused: 'سلام 🙏 الان در دسترس نیستیم؛ به‌زودی پاسخت را می‌دهیم.',
  },
  plans: {
    ...
    free: 'رایگان',
    perMonth: 'تومان / ماه',
    usageThisMonth: (n: string) => `${n} پیام این ماه`,
    paidUntil: (d: string) => `اعتبار تا ${d}`,
    success: 'پرداخت موفق بود؛ پلن فعال شد ✅',
    failed: 'پرداخت انجام نشد. دوباره تلاش کن.',
    names: { trial: 'آزمایشی', basic: 'پایه', pro: 'حرفه‌ای' },
    features: {
      trial: ['۵۰ گفتگو', '۱ کانال'],
      basic: ['۱٬۰۰۰ گفتگو', 'تلگرام + ویجت', 'کاتالوگ تا ۵۰۰'],
      pro: ['۵٬۰۰۰ گفتگو', '+ کمپین و گزارش هفتگی', 'نوشتن در ووکامرس'],
    },
  },
  connect: {
  ...
  landing: {
    ...
    subtitle: 'کسب‌وکارت را خودت اتومیت کن — بدون دانش فنی، همه‌چیز در گفتگو.',
    cta: 'شروع رایگان',
    values: [
      { title: 'آنبوردینگ ۱۰ دقیقه‌ای', desc: 'لینک سایت یا اینستاگرامت را بده؛ کاتالوگت خودکار خوانده می‌شود.' },
      { title: 'پاسخ‌گوی همیشه‌بیدار', desc: 'در تلگرام و سایت، درست از روی کاتالوگ و بدون قیمت‌سازی.' },
      { title: 'کنترل کامل با تو', desc: 'موارد حساس پیش‌نویس می‌شود تا خودت تأیید کنی.' },
    ],
    demo: {
      title: 'همین حالا امتحان کن',
      subtitle: 'لینک یک فروشگاه را بده و از دستیارش بپرس.',
      urlPlaceholder: 'https://example.com',
      check: 'بررسی سایت',
      checking: 'در حال خواندن…',
      found: (n: string) => `${n} محصول پیدا شد؛ حالا یک سؤال بپرس 👇`,
      failed: 'نتوانستم این سایت را بخوانم. یک فروشگاه دیگر امتحان کن.',
      askPlaceholder: 'مثلاً: ارزان‌ترین محصولتان چیه؟',
      ask: 'بپرس',
      asking: 'در حال پاسخ…',
